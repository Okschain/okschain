...
const char * const BITCOIN_CONF_FILENAME = "okschain.conf";
const char * const BITCOIN_PID_FILENAME = "okschain.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Okschain";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Okschain";
#else
    // Unix
    return pathRet / ".okschain";
#endif
#endif
}
