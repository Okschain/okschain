...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " okschain-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  okschain-tx [options] <hex-tx> [commands]  Update hex-encoded okschain transaction\n" +
            "or:     okschain-tx [options] -create [commands]   Create hex-encoded okschain transaction\n" +
            "\n";
