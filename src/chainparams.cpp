...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.okschain.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.okschaintools.com");
        vSeeds.emplace_back("dnsseed.okschainpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.okschaintools.com");
        vSeeds.emplace_back("seed-b.okschain.loshan.co.uk");
