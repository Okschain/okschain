# Support for Output Descriptors in Okschain Core

Since Okschain Core v0.17, there is support for Output Descriptors in the
...
on Okschain's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Okschain Core wallets, a convenience function `combo` is
