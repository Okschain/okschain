...
* okschain.conf: contains configuration settings for okschaind or okschain-qt
* okschaind.pid: stores the process id of okschaind while running
...
* debug.log: contains debug information and general logging generated by okschaind or okschain-qt
