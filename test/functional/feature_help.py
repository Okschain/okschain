...
"""Verify that starting okschain with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start okschain with -h for help text")
        ...
        self.log.info("Start okschain with -version for version information")
        ...
        self.log.info("Start okschaind with -fakearg to make sure it does not start")
